...
class Menu:
    ...
    def initialize_menu(self):
        ...
        menu_ui.add_button("Game Over", "default", "Restart", (150, 288), self.start_game_action)
        menu_ui.add_button("Game Over", "default", "Exit To Menu", (150, 399), self.return_to_main_menu_action)
        menu_ui.add_button("Game Over", "default", "Quit", (150, 488), self.exit_funct)

        menu_ui.add_menu("paused")
        menu_ui.add_button("paused", "default", "Resume", (150, 228), self.resume_game_action)
        menu_ui.add_button("paused", "default", "Restart", (150, 328), self.start_game_action)
        menu_ui.add_button("paused", "default", "Controls", (150, 428), self.controls_action)
        menu_ui.add_button("paused", "default", "Exit To Menu", (150, 528), self.return_to_main_menu_action)
        menu_ui.add_button("paused", "default", "Quit", (150, 628), self.exit_funct)
